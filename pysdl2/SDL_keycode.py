...
def SDL_SCANCODE_TO_KEYCODE(scancode):
...
class SDL_KeyCode:
	...
	SDLK_SOFTLEFT = SDL_SCANCODE_TO_KEYCODE(SDL_Scancode.SDL_SCANCODE_SOFTLEFT)
	SDLK_SOFTRIGHT = SDL_SCANCODE_TO_KEYCODE(SDL_Scancode.SDL_SCANCODE_SOFTRIGHT)
	SDLK_CALL = SDL_SCANCODE_TO_KEYCODE(SDL_Scancode.SDL_SCANCODE_CALL)
	SDLK_ENDCALL = SDL_SCANCODE_TO_KEYCODE(SDL_Scancode.SDL_SCANCODE_ENDCALL)
