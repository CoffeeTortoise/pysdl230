...
SDL_HINT_IDLE_TIMER_DISABLED = "SDLS_IDLE_TIMER_DISABLED"
...
SDL_HINTS_HIDE_HOME_INDICATOR = "SDLS_HIDE_HOME_INDICATOR"
...
SDL_HINT_JOYSTICKKIT = "SDL_JOYSTICKKIT"
...
SDL_HINT_ORIENTATIONS = "SDLS_ORIENTATIONS"
...
class SDL_HintPriority:
	SDL_HINT_DEFAULT = 0
	SDL_HINT_NORMAL = 1
	SDL_HINT_OVERRIDE = 2

LoadDLL.DLL.SDL_SetHintWithPriority.restype = ctypes.c_int
LoadDLL.DLL.SDL_SetHintWithPriority.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_int]
...
def SDL_SetHintWithPriority(name, value, priority):
	...
	Returns:
		res: ctypes.c_int.
	"""
	return LoadDLL.DLL.SDL_SetHintWithPriority(name, value, priority)


LoadDLL.DLL.SDL_ResetHint.restype = ctypes.c_int
LoadDLL.DLL.SDL_ResetHint.argtypes = [ctypes.c_char_p]

def SDL_ResetHint(name):
	"""
	Args:
		name: ctypes.c_char_p.
	Returns:
		res: ctypes.c_int.
	"""
	return LoadDLL.DLL.SDL_ResetHint(name)


LoadDLL.DLL.SDL_ResetHints.restype = None
LoadDLL.DLL.SDL_ResetHints.argtypes = []
...
def SDL_ResetHints():
	...
	Returns:
		res: None.
	"""
	LoadDLL.DLL.SDL_ResetHints()


LoadDLL.DLL.SDL_GetHint.restype = ctypes.c_char_p
LoadDLL.DLL.SDL_GetHint.argtypes = [ctypes.c_char_p]
...
def SDL_GetHint(name):
	...
	Returns:
		res: ctypes.c_char_p.
	"""
	return LoadDLL.DLL.SDL_GetHint(name)


LoadDLL.DLL.SDL_GetHintBoolean.restype = ctypes.c_int
LoadDLL.DLL.SDL_GetHintBoolean.argtypes = [ctypes.c_char_p, ctypes.c_int]

def SDL_GetHintBoolean(name, default_value):
	"""
	Args:
		name: ctypes.c_char_p.
	...
	Returns:
		res: ctypes.c_int.
	"""
	return LoadDLL.DLL.SDL_GetHintBoolean(name, default_value)


LoadDLL.DLL.SDL_ClearHints.restype = None
LoadDLL.DLL.SDL_ClearHints.argtypes = []
